...
The file "test_sum_commands.zip" contains a test of reading/writing a structure and an array
of structures with sum commands. I haven't added those features to the examples, so take a
look at the code in this file if you want to know more about it.
